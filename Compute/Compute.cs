...
namespace Compute
{
    ...
    /// </summary>
    internal sealed class Compute : StatelessService
    {
        public Compute(StatelessServiceContext context)
            : base(context)
        { }
        ...
        private ICommunicationListener CreateWcfCommunicationListener(StatelessServiceContext context)
        {
            ...
            var listener = new WcfCommunicationListener<ICompute>(
                serviceContext: context,
                wcfServiceObject: new ComputeService(),
